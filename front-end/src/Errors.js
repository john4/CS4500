...
export const NO_FOLLOWERS = "Oops, you have no followers. Try rating movies and following other users to gain visibility."
export const INVALID_LOGIN = "Invalid email or password"
export const OOPS = "Oops, "
export const INVALID_LINK = "Avatar image not available!"